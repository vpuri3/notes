...
\newcommand{\id}{\mathrm{id}}                                  % Operator
\newcommand{\I}{\mathcal{I}}                                   % Operator
\newcommand{\J}{\mathcal{J}}                                   % Operator
...
% under consideration
\newcommand{\ipr}[1]{\ensuremath{\langle #1 \rangle}}                   % operator application <T,x>
